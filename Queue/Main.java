...
public class Main {
    public static void main(String[] args) {
        QueueAnimal animals = new QueueAnimal();

        animals.enqueue(new Animal("Steven", true));
        animals.enqueue(new Animal("Jorden", true));
        animals.enqueue(new Animal("Fredbert", false));
        animals.enqueue(new Animal("Max", false));
        animals.enqueue(new Animal("Poe", true));
